...
class UserPost extends StatefulWidget {
  ...
  const UserPost({Key? key, this.diaryId}) : super(key: key);
...
class _UserPostState extends State<UserPost> {
  Mood _usermood =
      Mood.none; //temporarily store the input emotion (default: none)
  String text = "";
      ...
      try {
        ...
        await provider.sendTransaction(
            ...
            data: Transaction.callContract(
                ...
                function: function,
                parameters: [
                  EthereumAddress.fromHex(metamask.getAddress()),
                  cid
                ]).data,
            gas: 300000);
        return true;
  ...
  void post(String msg, Mood mood) async {
    ...
    bool success = (widget.diaryId == null
        ? await postWithMetamask(cid)
        : await newPageWithMetamask(cid));
                              ...
                              child: Row(
                                children: [
                                  PopupMenuButton<int>(
                                      ...
                                      icon: Text(
                                          moodEmoji[_usermood
                                              .index], // Replace with desired emoji//happy
                ...
                OutlinedButton(
                  onPressed: () {
                    ...
                    Navigator.of(context)
                        .push(materialPageRoute); // error on of(context)
                  },
